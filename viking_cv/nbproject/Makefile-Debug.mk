...
${OBJECTDIR}/CUpperGoalDetector.o: CUpperGoalDetector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DCV_DEBUG_CONNECT -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CUpperGoalDetector.o CUpperGoalDetector.cpp

${OBJECTDIR}/CUpperGoalRectangle.o: CUpperGoalRectangle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DCV_DEBUG_CONNECT -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CUpperGoalRectangle.o CUpperGoalRectangle.cpp
