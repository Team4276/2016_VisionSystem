...
LDLIBSOPTIONS=-lpthread -lopencv_core -lopencv_highgui -lopencv_imgproc
...
${OBJECTDIR}/CConnection.o: CConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CConnection.o CConnection.cpp

${OBJECTDIR}/CConnectionServer.o: CConnectionServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CConnectionServer.o CConnectionServer.cpp

${OBJECTDIR}/CFrameGrinder.o: CFrameGrinder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CFrameGrinder.o CFrameGrinder.cpp

${OBJECTDIR}/CGpioLed.o: CGpioLed.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CGpioLed.o CGpioLed.cpp

${OBJECTDIR}/CLedStrip.o: CLedStrip.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CLedStrip.o CLedStrip.cpp

${OBJECTDIR}/CMessageFromClient.o: CMessageFromClient.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CMessageFromClient.o CMessageFromClient.cpp

${OBJECTDIR}/CTargetInfo.o: CTargetInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CTargetInfo.o CTargetInfo.cpp
...
${OBJECTDIR}/CVideoFrame.o: CVideoFrame.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CVideoFrame.o CVideoFrame.cpp

${OBJECTDIR}/CVideoFrameQueue.o: CVideoFrameQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/CVideoFrameQueue.o CVideoFrameQueue.cpp

${OBJECTDIR}/dbgMsg.o: dbgMsg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/dbgMsg.o dbgMsg.cpp
